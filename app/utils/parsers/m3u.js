 ...
 * @type {string}
 */
export const PLAYLIST_TYPE = 'm3u';

/**
 * Matches any m3u-like string.
 * 
 * @public
 * @constant
 * @type {RegExp}
 */
export const M3U_MATCHER = new RegExp(PLAYLIST_TYPE + '$');
 ...
 * ```
 *
 * For more details on the m3u format, see: https://en.wikipedia.org/wiki/M3U
 *
 * @public
 * @function
 ...
 */
export function m3uParser(rawM3u = '') {
  // The parsed m3u representation.
  let m3u = {
    numberofentries: 0,
    tracks: [],
